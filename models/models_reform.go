...
type categoriesViewType struct {
	s parse.StructInfo
	z []interface{}
}

// Schema returns a schema name in SQL database ("").
func (v *categoriesViewType) Schema() string {
	return v.s.SQLSchema
}

// Name returns a view or table name in SQL database ("news_categories").
func (v *categoriesViewType) Name() string {
	return v.s.SQLName
}

// Columns returns a new slice of column names for that view or table in SQL database.
func (v *categoriesViewType) Columns() []string {
	return []string{
		"news_id",
		"category_id",
	}
...
// NewStruct makes a new struct for that view or table.
func (v *categoriesViewType) NewStruct() reform.Struct {
	return new(Categories)
}

// CategoriesView represents news_categories view or table in SQL database.
var CategoriesView = &categoriesViewType{
	s: parse.StructInfo{
		Type:    "Categories",
...
func init() {
	...
	parse.AssertUpToDate(&CategoriesView.s, new(Categories))
}
